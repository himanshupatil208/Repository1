...
def Application(root):
  '''Whole gui app'''
  root.geometry('{}x{}'.format(1000, 700))       #for fixed size window
  root.resizable(width=False, height=False)
  root.title("Audio Maker")
  ...
  #frame 1 widgets
  name1 = Label(frame1, text="JUST HEAR DONT READ", fg="white", bg="#8a2be2", font="Arial 40 bold")
  name1.pack()
  name2 = Label(frame1, text="A simple PDF to Audio reader which helps you to relief your eyes. ", fg="white",
                bg="#8a2be2", font="Calibri 15")
  name2.pack()

  #frame 2 widgets
  btn = Button(frame2, text='Select PDF file', command=extract_text, activeforeground="red", 
                padx="70", pady="20", fg="white", bg="black", font="Arial 20")
  ...
  voice_text = Label(frame2, text="Voice:", fg="black",bg="#e0ffff", font="Arial 15")
  ...
  submitBtn = Button(frame2, text='Play PDF file', command=speak_text, activeforeground="red",
               padx="60", pady="10", fg="white", bg="black", font="Arial 20")
